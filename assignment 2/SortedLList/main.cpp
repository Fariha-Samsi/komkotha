...
void runner_function()
{
    ...
    retrivedUser->addPhoneNumber("01216480638");
    retrivedUser->addPhoneNumber("01226480639");
    retrivedUser->addPhoneNumber("01936480640");
    retrivedUser->addPhoneNumber("01246480632");
    retrivedUser->addPhoneNumber("01556480650");

    while (!retrivedUser->hasNoPhoneNumber())
    {
